        ...
        <div class="fixed inset-0 overflow-y-auto">
          <div class="flex min-h-full items-center justify-center p-4">
            <DialogPanel class="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
              <DialogTitle class="text-lg font-semibold mb-4">Confirm Final Payment</DialogTitle>
              <p class="text-sm text-gray-600 mb-6">
                Are you sure you want to manually mark this order as <strong>PAID</strong>? 
                This should happen automatically when the user pays via Stripe. Only use this if payment was received externally.
              </p>
