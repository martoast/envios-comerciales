        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div v-if="request" class="flex items-center gap-3">
            ...
            <button 
              ...
              :disabled="processing"
              class="px-4 py-2 bg-purple-600 text-white font-medium rounded-lg hover:bg-purple-700 transition-colors shadow-sm flex items-center gap-2 disabled:opacity-50"
            >
                ...
                <div class="flex gap-4 items-start">
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <div v-if="item.options && Object.keys(item.options).length > 0" class="flex flex-wrap gap-2 mb-2">
                        <span v-for="(val, key) in item.options" :key="key" class="text-xs bg-purple-50 text-purple-700 border border-purple-100 px-2 py-1 rounded">
