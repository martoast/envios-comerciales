          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 animate-fadeIn">
              ...
              <div class="space-y-3">
                ...
                <div>
                  <p class="text-sm text-gray-500">{{ t.retailer }}</p>
                  <p class="font-medium text-gray-900">{{ packageItem.retailer || '-' }}</p>
                </div>
                <div>
                ...
                <div>
                  <p class="text-sm text-gray-500">{{ t.declaredValue }}</p>
                  <p class="font-medium text-gray-900">${{ packageItem.declared_value || '0.00' }} USD</p>
                </div>
              </div>
            </div>
