<template>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden animate-fadeIn" style="animation-delay: 0.3s">
          ...
          <div class="px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-100">
            <h2 class="text-lg sm:text-xl font-bold text-gray-900">{{ t.recentOrders }}</h2>
          </div>
          ...
          <div v-else-if="!loading && orders.length === 0" class="px-6 py-16 text-center">
            ...
            <p class="text-gray-500 mb-6 max-w-md mx-auto">{{ t.getStarted }}</p>
            <NuxtLink 
              to="/app/orders/create" 
  ...
  // PO Box Address - Static for now, you might want to make this dynamic
