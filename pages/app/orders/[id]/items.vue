  ...
  <section class="min-h-screen bg-gray-50 pb-32 sm:pb-24">
    ...
    <div class="max-w-3xl mx-auto px-4 py-6">
      ...
      <div v-else-if="order">
        ...
        <div class="sm:hidden bg-white rounded-2xl shadow-lg border border-gray-100 p-4 mb-6">
          <button
          ...
          >
            <div class="flex items-center gap-3">
              ...
              <span class="font-semibold">{{ t.addProduct }}</span>
            </div>
        ...
        <div class="hidden sm:block bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
    ...
    <div v-if="hasItems && order" class="fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg z-30">
      <div class="max-w-3xl mx-auto px-4 py-4">
        <div class="flex items-center gap-4">
          <div class="flex-1">
            <p class="text-sm text-gray-600">{{ t.readyToContinue }}</p>
            <p class="font-semibold text-gray-900">
              {{ totalItemQuantity }} {{ totalItemQuantity === 1 ? t.product : t.products }} {{ t.added }}
            </p>
          </div>
          <button
