<template>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div 
            ...
            :key="stat.label"
            class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 animate-fadeIn hover:shadow-md transition-all duration-300"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <!-- Recent Orders -->
          <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden animate-fadeIn" style="animation-delay: 1.2s">
          ...
          <div class="space-y-4">
            <!-- FAQ Card -->
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 animate-fadeIn" style="animation-delay: 1.3s">
              <div class="flex items-center gap-3 mb-4">
            ...
            <!-- Shipping Calculator -->
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 animate-fadeIn" style="animation-delay: 1.4s">
              <div class="flex items-center gap-3 mb-4">
            ...
            <!-- Contact Support -->
            <div class="bg-gradient-to-r from-primary-50 to-primary-100/50 rounded-2xl p-6 border border-primary-200/50 animate-fadeIn" style="animation-delay: 1.5s">
              <div class="flex items-center gap-3 mb-4">
  ...
  const quickStats = computed(() => [
    {
      ...
      value: dashboardStats.value?.totals?.total_orders || 0,
    ...
    },
    {
      ...
      value: (dashboardStats.value?.orders?.collecting || 0) + (dashboardStats.value?.orders?.awaiting_packages || 0),
      icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z',
      bgColor: 'bg-green-50',
      iconColor: 'text-green-600'
    },
    {
      label: t.value.totalItems,
      value: dashboardStats.value?.totals?.total_items || 0,
      icon: 'M20 7H4a2 2 0 00-2 2v6a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2zM9 12H5V9h4v3z',
      bgColor: 'bg-yellow-50',
      iconColor: 'text-yellow-600'
    },
    {
      ...
      value: dashboardStats.value?.orders?.awaiting_packages || 0,
      icon: 'M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0',
      bgColor: 'bg-primary-50',
      iconColor: 'text-primary-600'
    }
  ...
  const fetchDashboardStats = async () => {
    try {
      const response = await $customFetch('/profile/dashboard')
